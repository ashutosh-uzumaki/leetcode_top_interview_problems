...
public class MinimumTimeToCompleteAlternateTasks {
    /*
   Time complexity: O(n)
...
//INTUTION -> TASK WITH MAX FREQUENCY WILL REQUIRE TO BE IDLE AFTER COMPLETING IT'S ONE TASK IN FIRST CYCLE
